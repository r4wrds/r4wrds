...
<aside>
The troubleshooting module has a section on [how to read R's built-in help](12_troubleshooting.html#using-built-in-help).
</aside>
...
Awesome! We plotted some discharge data from a river. That's great. We could save this data if we wanted (see the [import/export module](03_importing_and_exporting_data.html)), or do additional analysis (see next [module on joins](08_joins.html)!). Let's try using a different function here. 
...
Let's visualize these sites with a fancy map! See the [mapmaking](09_intro_mapmaking.html) lesson for more details on making maps in R.
