...
```{r mutateFig, out.width='80%', echo=FALSE, fig.cap="Artwork by @allison_horst"}
...
The final core "verbs" we want to be sure folks are aware of, are `group_by` and `summarize`. These are really useful to tranform your data into an entirely **new** dataset.
