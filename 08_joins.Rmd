...
So there are 317 census tracts in Sacramento County, and 494 unique groundwater stations. So if we multiple 317 * 494, we get the number of observations in our dataset (`n=156,598`). So, it seems every single station is being joined to every single census tract...that's because we only have county to join on.
