...
A data.frame is made of many vectors of the same length. We can access a column using the `$` operator, and subset the vector with bracket notation `[`. To access the first entry in the `WELL_TYPE` column: 
