...
Let's tie this back to our spatial data answer the question, **"which areas have experienced the largest drop in groundwater levels over their historical period of record?"** We'll also impose a constraint that a well must have  30 or more groundwater level measurements, and a historical record that begins in 1980-01-01 or earlier. Moreover, since residential and irrigation wells have the most data and overlap in space, let's subset our data to these well uses categories in subsequent analyses. Now we find the `SITE_CODE`s that meet our constraints. 
