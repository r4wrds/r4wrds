...
Let's apply `params` to our task: generate an `html_document` per county. To illustrate, we will use a simplified, pre-processed dataset of 3 counties (Sacramento, Yolo, and San Joaquin counties).
