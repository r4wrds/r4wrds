...
```{r ciplot, layout="l-page", eval=TRUE, echo=TRUE, fig.cap="Static plot of CES data...how do we interact with these data?"}
...
```{r plotlyCI, layout="l-page", eval=TRUE, echo=TRUE}
...
<a href="m_version_control.html" class="btn btn-secondary" style="float: left">Previous module:<br>Version Control</a> <a href="m_simple_shiny.html" class="btn btn-secondary" style="float: right;">Next module:<br>Simple Shiny</a>
