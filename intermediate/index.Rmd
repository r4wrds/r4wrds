...
We will be working in an R project using RStudio. If you've already downloaded [**zipped data and Rproj file**](https://github.com/r4wrds/r4wrds-data-intro/raw/main/r4wds_proj.zip) from the introductory course, you're already set and can move on to the modules. 
...
1.  Download to a data folder in your project from a [Github repository](https://github.com/r4wrds/r4wrds-data-intro/):
