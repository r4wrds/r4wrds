...
```{r, fig.cap='(ref:xkcdGit)', out.height='90%', echo=FALSE}
...
```{r git1, echo=FALSE, out.width='80%'}

include_graphics(here("images", "team_and_task.png"))
...
Let's assume Jo is a wizard at grabbing the data we want to work with and saving it in an organized way. She's cloned the repository to her computer, and first thing she wants to do is create a fresh branch to work on.
