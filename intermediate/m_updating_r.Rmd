...
<a href="index.html" class="btn btn-secondary" style="float: left">Previous module:<br> Introduction</a> <a href="m_git.html" class="btn btn-secondary" style="float: right;">Next module:<br> 2. Git</a>
