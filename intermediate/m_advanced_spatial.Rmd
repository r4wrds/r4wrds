...
If there are issues running the `findNLDI` function via `{dataRetrieval}`, data can be downloaded with: `load(url("https://github.com/r4wrds/r4wrds/raw/update_spatial/intermediate/data/dataRetrieval_all_nldi_data.rda"))`.
...
mapview(sac_loi, col.region="purple", legend = FALSE, cex=2) +
  mapview(us_nwissite, col.regions="orange", legend =FALSE, layer.name="UM NWIS Sites") +
  mapview(us_flowlines, color="steelblue", lwd=2, layer.name="UM Flowlines", legend=FALSE)
