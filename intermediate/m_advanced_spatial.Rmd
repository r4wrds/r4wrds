...
Note, the `read_osm` package requires `{rJava}`, which may be tricky to install. Please see this poste on Github for a potential way to resolve these issues: https://github.com/rstudio/rstudio/issues/2254#issuecomment-418830716
...
```{r, include=FALSE}
# save(base_osm, file = glue("data", "m_advanced_spatial_base_osm.rda"))
load(glue("data", "m_advanced_spatial_base_osm.rda"))
```
