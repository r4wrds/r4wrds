...
Whether or not to write wrapper programs or set task schedulers depends on the needs of the workflow; guidance on when and when to not automate will be discussed in this module. 
...
The California Department of Water Resources publishes a routine report on groundwater level conditions that shows, on a point-by-point basis, the groundwater level trend at that point. Short-term (i.e., 1, 3, and 5 year) trends are shown, as well as long-term trends (i.e., 10 and 20 years). 

Imagine we want to assess change in groundwater level across all stations and plot it on a map.
