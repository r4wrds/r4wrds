...
<aside> Note, the `quiet = TRUE` option suppresses the printing of information about the spatial data being imported. Sometimes this information can be helpful, but see `read_sf()` which does the same thing as `st_read` but defaults to *quietly* reading in data.
</aside>
