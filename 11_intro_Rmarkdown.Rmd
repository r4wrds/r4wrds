...
Keep in mind this module has just scratched the surface. There many different types of outputs possible, including slide presentations (see [{xaringan}](https://slides.yihui.org/xaringan/#1) and [RStudio's page on slides](https://rmarkdown.rstudio.com/lesson-11.html)), pdfs, and word docs. 

There are many good resources freely available online. Here's a sample of some of them that may be of interest: 

- [RStudio's overview of different `.Rmd` output formats](https://rmarkdown.rstudio.com/lesson-11.html)
