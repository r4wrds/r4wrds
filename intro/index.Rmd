...
1. [Downloaded and unzipped from OSF](https://osf.io/d7qse/download)  
...
You will also need to create an `intro.Rproj` file, covered in the [introductory project management module](m_project_management.html#use-project-workflows). Alternatively, on the command line, use `touch intro.Rproj` (MacOS/Linux) or `echo > intro.Rproj` (Windows) in the root project directory.
