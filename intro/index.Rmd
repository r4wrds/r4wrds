...
1. [Downloaded from the `r4wrds-data` Github repository](https://github.com/r4wrds/r4wrds-data-intro)
2. [Downloaded and unzipped from OSF](https://osf.io/d7qse/download)  
