...
<a href="m_joins.html" class="btn btn-secondary" style="float: left">Previous module:<br> Joins and Binds</a>
<a href="m_exploratory_DA.html" class="btn btn-secondary" style="float: right;">Next module:<br> EDA</a>  
