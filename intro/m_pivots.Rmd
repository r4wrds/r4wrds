...
Let's take a look at this [**messy** spreadsheet data](https://github.com/r4wrds/r4wrds-data/raw/main/data/calenviroscreen/ces3results_messy.xlsx) which is based on data from the [Calenviroscreen data](https://oehha.ca.gov/calenviroscreen) from previous modules.
