...
Let's take a look at this [**messy** spreadsheet data](https://github.com/richpauloo/r4wrds-data/raw/main/data/calenviroscreen/ces3results_messy.xlsx) which is based on data from the [Calenviroscreen data](https://oehha.ca.gov/calenviroscreen) from previous modules.
...
<a href="m_dplyr.html" class="btn btn-secondary" style="float: left">Previous module:<br> Data Wrangling</a>
<a href="m_intro_mapmaking.html" class="btn btn-secondary" style="float: right;">Next module:<br> Spatial Data</a>  
