...
<a href="m_getting_started.html" class="btn btn-secondary" style="float: left">Previous module:<br> Getting started</a>
<a href="m_importing_and_exporting_data.html" class="btn btn-secondary" style="float: right;">Next module:<br> Import/export data</a>  
