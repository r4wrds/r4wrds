...
To import a shapefile into `R`, we need to use the `{sf}` package and `st_read`. What does adding `quiet = TRUE` do to your import? Try it!

```{r import-sf, echo=TRUE, eval=TRUE, exercise = TRUE}
# import to R as sf
library(sf)
shpfile <- st_read(here("worksheets/CES3_shp/CES3June2018Update.shp"), ___)

```

```{r import-sf-solution}
# import to R as sf
library(sf)
