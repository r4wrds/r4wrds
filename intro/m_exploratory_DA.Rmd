...
knitr::include_graphics(here("images", "aquifer.png"))
```
...
<a href="m_intro_mapmaking.html" class="btn btn-secondary" style="float: left">Previous module:<br> Spatial Data</a>
<a href="m_intro_Rmarkdown.html" class="btn btn-secondary" style="float: right;">Next module:<br> RMarkdown</a>  
