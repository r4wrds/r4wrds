...
If you want to learn more about {ggplot2}, the definitive text is [ggplot2: elegant graphics for data analysis](https://ggplot2-book.org/index.html).  
...
<a href="m_importing_and_exporting_data.html" class="btn btn-secondary" style="float: left">Previous module:<br> Import/Export Data</a>
<a href="m_data_structures.html" class="btn btn-secondary" style="float: right;">Next module:<br> Data Structures</a>  
