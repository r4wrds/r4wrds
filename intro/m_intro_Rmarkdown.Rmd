...
<a href="m_exploratory_DA.html" class="btn btn-secondary" style="float: left">Previous module:<br> EDA</a>
<a href="m_troubleshooting.html" class="btn btn-secondary" style="float: right;">Next module:<br> Troubleshooting</a>  
