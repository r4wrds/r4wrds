...
stations <- read_csv("https://github.com/r4wrds/r4wrds/blob/webfixes/intro/data/gwl/stations.csv?raw=true")
```
...
write_csv(stations, here("data_output", "my_stations.csv"))
```
...
file.exists(here("data_output", "sacramento_county.shp"))
file.exists(here("data_output", "sac_county.shp"))
file.exists(here("data_output", "sac_county.rds"))
```
...
my_breakfast <- read_rds(here("data_output", "breakfast.rds"))
