...
stations <- read_csv("https://raw.githubusercontent.com/richpauloo/wrds/main/data/gwl/stations.csv")
```
...
<a href="m_project_management.html" class="btn btn-secondary" style="float: left">Previous module:<br> Project management</a>
<a href="m_ggplot.html" class="btn btn-secondary" style="float: right;">Next module:<br> Data visualization</a>  
