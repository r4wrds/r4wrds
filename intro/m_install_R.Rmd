...
We'll be working with a few different datasets for this workshop (see [here](https://github.com/r4wrds/r4wrds-data-intro)). We've zipped all these files into a single folder, which can be downloaded [here](https://github.com/r4wrds/r4wrds-data-intro/raw/main/data.zip). Bear in mind this **`.zip`** file is ~30 MB in size, and may take a few minutes to download depending on internet connections.

 - [**Download the zipped file of all intro course data**](https://github.com/r4wrds/r4wrds-data-intro/raw/main/data.zip).
