...
Go to [CRAN and download](https://cran.rstudio.com/bin/windows/base/) the R installer for Windows. Make sure to choose the latest stable version (v4.1.3 as of Apr 2022). Download the <font color="#0072B2">`.exe`</font> file and double click to install.
...
![](images/rstudio_console.png#inline-img "RStudio console")
 ...
 - **Verify your installed R version is `v4.1.3`**: Ideally you should be running the latest stable release (`v4.1.3` as of Apr 2022). If you have an older version, please install the newest version using the instructions above.
