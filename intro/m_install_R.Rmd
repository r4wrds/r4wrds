...
![](images/rstudio_console.png#inline-img "RStudio console")
 ...
 - **Verify your installed R version is `v4.0.4`**: Ideally you should be running the latest stable release (`v4.0.4` as of March 2021). If you have an older version, please install the newest version using the instructions above.
...
<a href="m_getting_started.html" class="btn btn-secondary" style="float: right;">Next module:<br> Getting started</a>  
