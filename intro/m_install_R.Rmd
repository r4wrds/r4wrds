...
After that message type "**Yes**" and hit "**Enter**" on the keyboard. 
...
For MacOS users, follow the recommended instructions on the [{`sf`}](https://r-spatial.github.io/sf/) webpage, which if possible, requires successfully installing [Homebrew](https://brew.sh/), then running in the Terminal:
