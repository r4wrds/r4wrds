...
For some of the mapping and spatial lessons, we need a set of geospatial tools/packages. For the majority of the content we will cover, this requires installation of the [{`sf`}](https://r-spatial.github.io/sf/) package. If installing from a binary package, this should work (just make sure to type "**No**" when asked about `install from sources`):
