...
We'll be working with a few different datasets for this workshop (see [here](https://github.com/r4wrds/r4wrds-data)). We've zipped all these files into a single folder, which can be downloaded [here](https://osf.io/d7qse/download). Bear in mind this **`.zip`** file is ~170 MB in size, and may take a few minutes to download depending on internet connections.
