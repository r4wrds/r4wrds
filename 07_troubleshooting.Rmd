...
If you're having an error, chances are someone else has had the same problem before and you can solve your problem just by asking the right question. Take note of the date that a post was written, and whenever possible, try to find/read more recent answers first. Sometimes there may be answers available but they are applicable to much older versions of R (or to out of date packages or functions) because they are from many years ago.
