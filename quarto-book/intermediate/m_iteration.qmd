...
[^2]: For a review of `R`'s `list` data structure, see the [data structures module](../intro/m_data_structures.qmd#list) and Hadley Wickham's excellent *"R for Data Science"* chapter on [vectors](https://r4ds.had.co.nz/vectors.html).
...
We could capture these transform steps in a function, store it in our `/functions` folder [as described in the project management module](../intro/m_project_management.qmd#strategies-to-organize-projectscode), and in this way, clean up our workspace so we can keep track of the functions applied on our data and keep our scripts short and readable.
