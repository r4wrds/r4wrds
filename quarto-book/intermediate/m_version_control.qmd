...
```{r, fig.cap="*Learn to leverage the power of git for things other than just a backup! (Figure from <https://xkcd.com/1597/>).*", out.width='60%', echo=FALSE, eval=FALSE, out.extra="class=external"}
...
```{r startingBranch, eval=TRUE, echo=FALSE, fig.cap="<font color=\"#5f3dc4\">**Jo**</font> creates a new branch from <font color=\"#e67700\">**`main`**</font> to write a data download script in `R`.", out.height='80%'}
...
```{r gitstage1, eval=TRUE, echo=FALSE, out.width="49%", fig.show='hold'}
...
```{r gitstage2, eval=TRUE, echo=FALSE, fig.show='hold'}
...
```{r gitstage3, eval=TRUE, echo=FALSE, fig.show='hold'}
...
```{r gitstage4, eval=TRUE, echo=FALSE, fig.show='hold'}
...
```{r VizExample, eval=TRUE, echo=FALSE, fig.show='hold'}
