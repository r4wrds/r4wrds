...
Next, visit the [`R` CRAN website](https://cran.r-project.org/) to see what the most recent version is. If you haven't updated recently, go ahead and grab the most recent `R` version for your system and [install it](https://r4wrds.com/intro/m_install_R.qmd#step-1.-install).
...
Read more about `{renv}` in the [project management module](../intro/m_project_management.qmd#renv).
