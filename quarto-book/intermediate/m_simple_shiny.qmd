...
According to the [Mastering Shiny](https://mastering-shiny.org/index.qmd) book:
...
```{r shiny-screenshot, eval=T, echo=F, preview = TRUE}
...
-   [Mastering Shiny](https://mastering-shiny.org/index.qmd): Free online book that serves as an authoritative guide on how to build, maintain, deploy, and customize R Shiny Apps. Material goes well beyond what is presented in this module.\
