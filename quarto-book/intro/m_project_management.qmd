...
```{r tidyplotgraphic, eval=TRUE, out.width='100%', fig.cap="*Change defaults to never save your workspace to `.RData`! (Credit to Jenny Bryan and Jim Hester at [rstats.wtf](https://rstats.wtf/save-source.html))*", preview = TRUE}
