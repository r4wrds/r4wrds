...
When a package is installed, that means the source code is downloaded and put into your library. Let's give it a shot using the [{`tidyverse`}](https://tidyverse.tidyverse.org/index.qmd), a set of packages assembled for data tidying and visualization purposes.
