...
<center>
```{r gridlock, echo=FALSE, fig.cap="Merging Data? *(source Wikipedia Commons)*", out.height="50%", preview = TRUE}
...
```{r AHmeetData, echo=FALSE, out.width="80%", fig.cap="*Artwork by @allison_horst*"}
...
```{r face, echo=FALSE, out.height="2%", fig.cap="*Artwork by @allison_horst*"}
