...
```{r ggplot-evl, eval=TRUE, echo=FALSE, out.width='80%', fig.cap="*Illustration by @allison_horst.*"}
...
```{r ggplot-evol, eval=TRUE, echo=FALSE, out.width='80%', fig.cap="*[Evolution of a ggplot](https://www.cedricscherer.com/2019/05/17/the-evolution-of-a-ggplot-ep.-1/), by Cedric Scherer shows how one can progressively refine and customize a gpplot.*"}
knitr::include_graphics("images/ggplot_evolution.gif")
```


```{r p1, eval=TRUE, echo=FALSE, out.width='80%', fig.cap="*Created by [Timo Grossenbacher](https://timogrossenbacher.ch/2016/12/beautiful-thematic-maps-with-ggplot2-only/) @grssnbchr.*"}
knitr::include_graphics("images/switzerland.png")
```


```{r p2, eval=TRUE, echo=FALSE, out.width='80%', fig.cap="*Travelling to Outer Space by [Cédric Scherer](https://www.cedricscherer.com/top/dataviz/) @CedScherer.*"}
