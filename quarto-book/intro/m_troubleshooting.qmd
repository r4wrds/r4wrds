...
<aside> Recall the classes of atomic vectors (logical, numeric, factor, character) from the [module on data structures](m_data_structures.qmd#basic-object-classes). </aside>
