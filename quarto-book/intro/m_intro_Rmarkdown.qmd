...
```{r rmarkdownwiz, eval=TRUE, echo=FALSE, out.width='100%', fig.cap="*Illustration by @allison_horst*"}
...
```{r reproducible, eval=TRUE, echo=FALSE, out.width='100%', fig.cap="*Illustrations from the [Openscapes](https://www.openscapes.org/) blog [Tidy Data for reproducibility, efficiency, and collaboration](https://www.openscapes.org/blog/2020/10/12/tidy-data/) by Julia Lowndes and Allison Horst\"*"}
...
```{r make-nwis-mapview, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
library(mapview)
