...
description: 'Unleashing the power of reproducible workflows with "R for Water Resources
  Data Science" (R 4 WRDS).
...
```{r remoteLearning, eval=TRUE, echo=FALSE, out.width='60%', fig.cap="*Artwork by @allison_horst*"}
...
1. [Install R and RStudio](m_install_R.qmd)  
2. [Get oriented in RStudio](m_getting_started.qmd)  
3. [Practice data and file management: understand RProjects and file paths](m_project_management.qmd) 
4. [Import and export various water resources data](m_importing_and_exporting_data.qmd)   
5. [Visualize data with `ggplot2`](m_ggplot.qmd)   
6. [Understand and identify different data structures (i.e., vectors, dataframes, lists)](m_data_structures.qmd)    
7. [Transform data with `dplyr`](m_dplyr.qmd)    
8. [Discuss spreadsheets and pivots](m_pivots.qmd)    
9. [Learn how to write custom functions](m_functions.qmd)  
10. [Join different datasets together](m_joins.qmd)  
11. [Use spatial data to create static and interactive maps](m_intro_mapmaking.qmd)  
12. [Explore strategies for Exploratory Data Analysis (EDA)](m_exploratory_DA.qmd)  
13. [Practice data presentation and communication with `RMarkdown`](m_intro_Rmarkdown.qmd)  
14. [Explore strategies for troubleshooting (reading documentation, intro to reprex)](m_troubleshooting.qmd)  
...
To complete code exercises and follow along in the course, we will create these folders and download the data in the [introductory project management module](m_project_management.qmd#use-project-workflows). 
