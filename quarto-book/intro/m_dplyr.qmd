...
```{r tidywrangle, eval=TRUE, echo=FALSE, out.width='100%', fig.cap="*Illustration by @allison_horst, from Hadley Wickham's talk \"The Joy of Functional Programming (for Data Science)\"*"}
